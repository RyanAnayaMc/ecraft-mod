...
public class PicksawItem extends MiningToolItem {
    ...
    public PicksawItem(ToolMaterial material, Settings settings) {
        super(material, ETags.Blocks.PICKSAW_MINEABLE, settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (PicksawItem.shouldCancelStripAttempt(context)) {
