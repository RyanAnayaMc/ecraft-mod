...
public class MetallurgiumSpearEntityModel extends EntityModel<MetallurgiumSpearEntity> {
    ...
    public MetallurgiumSpearEntityModel(ModelPart root) {
    ...
    @Override
    public void setAngles(MetallurgiumSpearEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
